<template>
  <header class="d-flex align-items-center p-4">
    ...
    <a class="mr-4" href="mailto:hi@bugzilla.app">Contact us</a>
    <a
      class="mr-4"
    ...
    <a class="mr-4" href="/signin">Log in</a>
    ...
    <div class="row">
      <div class="col-12">
        ...
        <p>
          ...
          use of Bugzilla's Website, located at http://bugzilla.uk.to.
        </p>
        <p>
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use Bugzilla if you do not agree to
        ...
        <p>
          <span class="mr-1">
            We employ the use of cookies. By accessing Bugzilla, you agreed to
            use cookies in agreement with the Bugzilla's
          </span>
        ...
        <p>
          ...
          Bugzilla for your own personal use subjected to restrictions set in
        ...
        <p>
          ...
          Bugzilla does not filter, edit, publish or review Comments prior to
          their presence on the website. Comments do not reflect the views and
          opinions of Bugzilla,its agents and/or affiliates. Comments reflect
          the views and opinions of the person who post their views and
          opinions. To the extent permitted by applicable laws, Bugzilla shall
        ...
        <p>
          You hereby grant Bugzilla a non-exclusive license to use, reproduce,
        ...
        <p>
          ...
          the hyperlink compensates the absence of Bugzilla; and (d) the link is
        ...
        <p>
          ...
          sending an e-mail to Bugzilla. Please include your name, your
  ...
  <div class="text-center my-4">
    <a class="btn btn-primary btn-lg" href="mailto://sales@bugzilla.app">
      Contact sales
    </a>
  </div>
</template>
