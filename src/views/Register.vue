<template>
  <header class="d-flex align-items-center p-4">
    <a class="mr-auto" href="/">
      <img
        height="48"
        src="/images/bootstrap-ba23603c8668f4fe65dc2c7996053224.svg?vsn=d"
        width="48"
      />
    </a>
    <a class="btn btn-lg btn-outline-primary" href="/signin">Sign in</a>
  </header>
  <form action="/signup" class="form-signin bg-white p-4" method="post">
    ...
    <div class="form-group">
      <label class="d-block font-weight-normal text-secondary">
        <input name="user[terms_accepted]" type="hidden" value="false" />
        <input
          ...
          value="true"
          required
        />&nbsp;I agree to Bugzilla&nbsp;<a href="/terms" target="_blank"
          >Terms</a
